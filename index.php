      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Ayush Phadatare</h4>
            <p><em>Enthusiastic and results-driven Full Stack Web Developer with 5 months of experience building dynamic and responsive web applications, leveraging both front-end and back-end technologies to create user-friendly and efficient solutions.</em></p>
            <p>
            <ul>
              <li>Vashi Navi Mumbai</li>
              <li>(+91) 9653634752</li>
              <li>ayushphadatare065@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            <h4>Bachelor of Computer Science &amp; Full stack WEb Developer</h4>
            <h5>2022 -2025</h5>
            <p><em>Karmaveer Bhaurao Patil College</em></p>
            <p>To work for 'Better Tomorrow' through educational advancement of society while keeping social justice and social obligations in mind.</p>
          </div>
          <div class="resume-item">
            <h4> &amp; HSC </h4>
            <h5>2021</h5>
            <p><em>Karmaveer Bhaurao Patil College</em></p>
            <p>Upholding academic excellence and integrity as core principles.
              Fostering a culture of diversity, and inclusivity.
              Promoting social responsibility through community engagement.</p>
          </div> 
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            <h4>Junior Web Site Developer</h4>
            <h5>25 march 2024 - 25 june 2024</h5>
            <p><em>UNV Digital </em></p>
            <p>
            <ul>
              <li>Lead in the design, development, and implementation of the graphic, layout, and production communication materials</li>
              <li>Delegate tasks to the 7 members of the design team and provide counsel on all aspects of the project. </li>
              <li>Supervise the assessment of all graphic materials in order to ensure quality and accuracy of the design</li>
              <li>Oversee the efficient use of production project budgets ranging from RS 40,000 - RS 1,50,000 + /li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            <h4>Web Site and Graphic Designer</h4>
            <h5>20 March 2023 - 25 may 2023</h5>
            <p><em>RCIIF Kharger</em></p>
            <p>
            <ul>
  ...
  <section id="contact" class="contact">
    <div class="container">
      ...
      <form action="#" method="post" class="mt-4">
        ...
        <div class="text-center" style><button type="submit" name="send_message">Send Message</button></div>
      </form>
